...
$kraken = new KrakenClient($key, $secret, $url, $version, $sslverify);
...
$res = $kraken->QueryPublic('Ticker', ['pair' => 'XBTCZUSD']);
\print_r($res);
 ...
 */
$res = $kraken->QueryPublic('Trades', ['pair' => 'XBTCZEUR', 'since' => '137589964200000000']);
\print_r($res);
